...
{ 'name': 'Customized Refrigerator', 'description': `
 Team SRM robocon : The team developed a cutting-edge refrigeration system with a sophisticated triple-layer insulation setup. The first layer of insulation comprised wool, the second layer utilized foil, and the third layer consisted of silver bubble wrap. This multi-layered approach ensured optimal thermal protection.The refrigeration system employed hybrid cooling methods, integrating both air and water cooling techniques. It featured compressors and pumps to enhance cooling efficiency and included four Peltier modules to boost performance further. For precise monitoring and control, the system was equipped with a temperature sensor and a load cell. Power for the entire system was supplied through a Switch Mode Power Supply (SMPS), ensuring reliable and efficient energy use. 
 Team SAMBED:The SAMBED ROBOCON team comprising Aarush Bhandari, Akhil Anil, Nagesh Yenigalla, Aditya, and Shohan Saha, has innovatively developed a sophisticated smart storage system that integrates advanced cooling technology with IoT capabilities. This cutting-edge system features a Peltier module complemented by a network of strategically placed fans and a powerful compressor to ensure efficient and consistent cooling. The system's insulation is fortified with Rockwool to maintain optimal temperatures and protect against external heat influences.Central to the smart storage system's functionality is the ESP32 microcontroller, which enables seamless remote monitoring and control of various parameters, such as temperature and humidity. This is achieved through a custom-designed mobile application, providing users with real-time insights and the ability to make adjustments on the go.The structure of the storage system is crafted from sustainable materials, including wood and metals, emphasizing eco-friendliness and durability. This combination of advanced technology, innovation, and sustainability aligns perfectly with the hackathon's objectives, showcasing the team's commitment to creating impactful, environmentally conscious solutions.This project not only highlights the team's technical prowess but also demonstrates a forward-thinking approach to addressing modern challenges with smart, sustainable design.
 Team F-32 (Fahrenheit-32, referring to zero degrees Celsius) consisted of Mohammed Sadriwala, Siddhartha Sawant, and Amshu Kiran Belbase. They developed a refrigeration system using a Peltier junction powered by buck converters. For efficient heat transfer, BLDC fans with heat sinks were employed. To monitor temperature, DTH sensors were integrated into the system, and an ESP8266 microcontroller was used. The IoT implementation utilized the Blynk app, displaying parameters like coolness and humidity on an OLED screen mounted on the top of the device.


`, 'coverImage': '/projects/Refrigirator-CAD.webp', 'abstract': "The team developed an advanced refrigeration system featuring a triple-layer insulation setup: wool, foil, and silver bubble wrap, a sophisticated smart storage system integrating advanced cooling technology and IoT capabilities and a refrigeration system using a Peltier junction and buck converters.", 'gallery': ['/projects/gallery/customrefrig/ref1.jpg','/projects/gallery/customrefrig/ref2.jpg','/projects/gallery/customrefrig/ref3.jpg','/projects/gallery/customrefrig/ref4.jpg','/projects/gallery/customrefrig/ref5.jpg','/projects/gallery/customrefrig/ref6.jpg','/projects/gallery/customrefrig/ref7.jpg','/projects/gallery/customrefrig/ref8.jpg','/projects/gallery/customrefrig/ref9.jpg','/projects/gallery/customrefrig/ref10.jpg'], dimensions: { 'height': 662, 'width': 817 },shortkey:'The team developed an energy-efficient refrigerator using an ESP8266 WiFi module, PWM for Peltier control, and a balsa wood body for the Smart Agro Event. AC current was used as the power source, and the refrigerator included a humidifier and an OLED display.' }, 
