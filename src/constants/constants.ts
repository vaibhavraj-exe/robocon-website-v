...
export const noOfParticipations = 8;
...
export const projects: Event[] = [
  {
    name:`Cheepa Robot`,
    description:`The Cheepa Robot is a truly innovative device that was developed by Ayushman Das, Agamjot Kaur Choudhary, and Asutosh Kumar Chouhan for the Smart Agro Event organised by the IEI Department. It is intended to be both efficient and portable, with the ability to measure a variety of air quality parameters, as it is inspired by birds. The sensors of Cheepa are capable of measuring pressure, humidity, particulate matter (PM 2.5), carbon monoxide (CO), and volatile organic compounds (VOCs). This renders it a comprehensive instrument for the monitoring of air quality. It also has additional sensors that are essential for the early detection of fires and the protection of individuals. They detect the presence of smoke. The pulse oximeter feature is crucial for health and safety, as it measures the levels of carbon monoxide in the air, which can be harmful at high levels. The robot is equipped with an integrated airflow system that facilitates the precise measurement of air samples by drawing them into the sensors. The OLED screen is capable of displaying all the measured data in real-time, thereby facilitating the comprehension and reading of the air quality levels. Its design is influenced by birds, which makes it lightweight and convenient to transport, making it ideal for on-the-go air quality monitoring. The Cheepa Robot is a prime illustration of how technology can be employed to develop portable and effective environmental monitoring devices.`,
    coverImage:"/projects/cheepa.png",
    abstract:`Inspired by birds, the ‘Cheepa’ Robot is a unique portable air quality measuring device that uses BME680 sensors to measure rising VOCs, PM 2.5, CO, pressure, and humidity. It also incorporates smoke sensors and has an installed pulse oximeter to measure the levels of carbon monoxide. It features an airflow system as well as an OLED screen that displays all of these details.`,
    gallery:[]


  },
  {
    name:'Customized Refrigerator',
    description:``,
    coverImage:'',
    abstract:`This project was developed by Aarush Bhandari, Aditya Rahul Pradhan, and Shohan Saha from the SAMBED Domain of SRM Team Robocon in order to take part in the Smart Agro Event organised by the IEI Department. The problem statement was to create a model that was energy efficient and used a solar panel as it's battery source. The WiFi module installed in the project was ESP8266 . For the purpose of keeping fruits and vegetables fresh, a humidifier was additionally installed in the refrigerator. The PWM (pulse width modulation) technique is used for Peltier to control the mobile app that was developed by Nagesh and used for camera feedback. The body of the refrigerator was made of balsa wood. In real-world scenarios, solar panels should be used to make the refrigerator more energy efficient; however, they were unable to be used, and hence AC current was used as the source supply for it. The refrigerator is also fitted with an OLED display screen.`,
    gallery:[]

  },
  {
    name: "PYRO",
    description: `This independent four-wheel-drive vehicle boasts an omnidirectional mobility system that enables fine control and maneuverability, as well as a square chassis that provides stability and agility for seamless travel in a range of conditions. It makes use of UV-C tubes are positioned with care for disinfection and sterilization. Pyro employs UV-C radiation, which is the UV light spectrum's most potent component, to damage dangerous microorganisms on items and surfaces that fall within a specific range. To improve concentration and accuracy, it also has a concave metal foil in the front. This design optimizes the UV lights' exposure to a specific area procedure for disinfection. This cutting-edge automobile is useful in a number of environments where sanitization is crucial, such as medical facilities, research labs, and residential and business complexes. With a remarkable level of sanitization effectiveness, with about 98.5%, Pyro is a state-of-the-art method for preserving sanitary surroundings.`,
    coverImage: "/projects/pyro.png",
    abstract: `The Pyro is a self-sufficient four-wheel-drive vehicle with a square chassis for stability and agility and omnidirectional mobility for precise control. It uses UV-C tubes for sterilization and disinfection, using the most powerful part of the UV radiation spectrum to destroy harmful bacteria on surfaces and objects. The vehicle's design maximizes the disinfection process by focusing UV lamps on specific regions. With an impressive sanitization efficiency of around 98.5%, Pyro is a cutting-edge solution for maintaining hygienic environments in settings like hospitals, research labs, commercial complexes, and residences.`,
    gallery: []
  },
  {
    name:"ROV",
    description:`The SRM Team, comprising Roel Pais, Nikit Mathur, Adheesh Mathur, Pranav Malakar, Tamanna Grover, and Danush Ramakrishnan, recently participated in the Smart India Hackathon, addressing a significant challenge in hydroelectric projects (HEPs). The task involved creating a solution for the uninterrupted monitoring of Head Race Tunnels (HRTs), a critical component in hydropower operations. The team proposed deploying remotely operated vehicles (ROVs) equipped with advanced sensors and high-resolution cameras for submerged inspections. These ROVs enable early detection of structural issues, ensuring operational safety, reducing downtime, and lowering maintenance costs. The autonomous nature of ROVs eliminates the need for manual inspections, thus preventing interruptions in hydropower production. Additionally, the ROVs play a role in environmental monitoring by collecting real-time data on water quality and biodiversity, which supports sustainable hydropower practices. This comprehensive solution addresses both operational and ecological aspects, aligning hydropower projects with efficiency and environmental stewardship.`,
    coverImage:"/projects/ROV.jpeg",
    abstract:`SRM Team Robocon participated in the Smart India Hackathon to address challenges related to hydroelectric projects. They proposed using remotely operated vehicles (ROVs) for submerged inspections, preventing operational disruptions and enabling early detection of issues. These ROVs also contribute to environmental monitoring by collecting real-time data on water quality and biodiversity, supporting sustainable hydropower operations.`,
    gallery: []
  ...
  {
    name:"Line Follower",
    description:`The Margdarsak Line Follower, developed by Smit Prajapati for the Fluxus Techfest organized by IIT Indore, is an innovative robot designed to navigate and follow a line with unparalleled precision. This advanced project utilizes N20 12V gear motors, a 3S battery, a 7-channel IR sensor array, an Arduino Nano, and an L298N motor driver to achieve its exceptional line-following capabilities. The inclusion of a Castrol wheel allows for multidirectional movement, greatly enhancing its maneuverability on the track. The seamless integration of these high-tech components ensures that the Margdarsak Line Follower can efficiently follow complex paths, showcasing its reliability and performance. This achievement was reflected in its top 3 finish at the competition, highlighting the project's success and innovation. Demonstrating a profound understanding of robotics and sensor integration, this project pushes the boundaries of autonomous robotic navigation, making it a noteworthy contribution to the field. Through meticulous design and engineering, Smit Prajapati's creation stands as a testament to the potential of advanced robotics in tackling intricate navigation challenges.`,
    coverImage:"/projects/Line-follower.jpeg",
    abstract:`The Margdarsak Line Follower, developed by Smit Prajapati for the Fluxus Techfest by IIT Indore, uses N20 12V gear motors, a 3S battery, a 7-channel IR sensor array, an Arduino Nano, and an L298N motor driver for precise line-following. The Castor wheel enhances its maneuverability, resulting in a top 3 finish at the competition. This project showcases robotics and sensor integration, pushing the limits of autonomous robotic navigation.`,
    gallery:[]
